...
I only had a bit of trouble passing the tests for the children's names. At first I tried to create carson.name all in one go, but once I split it up it passed the test.
How difficult was it to add and delete properties outside of the object itself?
It wasn't very difficult adding or deleting outside the object at all.
What did you learn about manipulating objects in this challenge?
It's very easy to access the properties of objects in JavaScript and to manipulate them.
*/
